...
- Click on the link generated by GitHub Classroom and follow the instructions there. Github classroom should create a corresponding repository for you (depending on whether you pick Python or Java. Please pick and create only one of the two.)
